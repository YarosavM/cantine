...
//	wp_register_script( 'html5-shim', 'http://html5shim.googlecode.com/svn/trunk/html5.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
    ...
    /*** My scripts ***/
    wp_register_script( 'ale_app', THEME_URL . '/js/app.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'ale_vendor_foundation', THEME_URL . '/js/vendor/foundation.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'ale_vendor_foundation_min', THEME_URL . '/js/vendor/foundation.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'ale_vendor_jquery', THEME_URL . '/js/vendor/jquery.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'ale_vendor_what_input', THEME_URL . '/js/vendor/what-input.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );

	wp_enqueue_script( 'ale_app' );
	wp_enqueue_script( 'ale_vendor_foundation' );
	wp_enqueue_script( 'ale_vendor_foundation_min' );
	wp_enqueue_script( 'ale_vendor_jquery' );
	wp_enqueue_script( 'ale_vendor_what_input' );
    /*** --- ***/
